...
import net.fukuri.memberapp.adapter.CouponListAdapter;
import net.fukuri.memberapp.api.MyCallBack;
...
import net.fukuri.memberapp.model.VersionReponse;
import net.fukuri.memberapp.model.XMLUpdate;
