...
import net.fukuri.memberapp.model.AreaCouponPost;
import net.fukuri.memberapp.model.MessageEvent;
import net.fukuri.memberapp.ui.BaseFragmentToolbarBottombar;
...
public class PostAreaWebViewFragment2 extends BaseFragmentToolbarBottombar {
    ...
    public static PostAreaWebViewFragment2 newInstance() {
        PostAreaWebViewFragment2 postAreaWebViewFragment = new PostAreaWebViewFragment2();
        return postAreaWebViewFragment;
    }
