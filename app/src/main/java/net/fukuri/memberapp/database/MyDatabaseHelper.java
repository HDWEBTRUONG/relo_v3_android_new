package net.fukuri.memberapp.database;
...
import net.fukuri.memberapp.database.tables.TableCategory;
import net.fukuri.memberapp.database.tables.TableCoupon;
import net.fukuri.memberapp.database.tables.TableFav;
import net.fukuri.memberapp.database.tables.TablePush;
import net.fukuri.memberapp.model.CatagoryDTO;
import net.fukuri.memberapp.model.CouponDTO;
