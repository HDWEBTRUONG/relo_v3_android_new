...
public abstract class MaterialSpinnerBaseAdapter <T> extends BaseAdapter {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(com.jaredrummler.materialspinner.R.layout.ms__list_item, parent, false);
            textView = (TextView) convertView.findViewById(com.jaredrummler.materialspinner.R.id.tv_tinted_spinner);
