 ...
 */
public class DragAndZoomView extends View {
    ...
    public DragAndZoomView(final Context context) {
        super(context);
        init();
    }

    public DragAndZoomView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }
