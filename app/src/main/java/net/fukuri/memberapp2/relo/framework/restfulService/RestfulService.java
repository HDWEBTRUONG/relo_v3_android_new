package net.fukuri.memberapp2.relo.framework.restfulService;
...
import net.fukuri.memberapp2.relo.framework.phvtUtils.AppLog;
import net.fukuri.memberapp2.relo.framework.phvtUtils.NetworkUtil;
import net.fukuri.memberapp2.relo.framework.restfulService.parser.IParser;
import net.fukuri.memberapp2.relo.main.util.DialogFactory;
import net.fukuri.memberapp2.relo.main.util.NoSSLv3SocketFactory;
